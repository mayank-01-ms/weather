...
fifthDay.innerHTML = addDays(1).toDateString().slice(0, -5);
sixthDay.innerHTML = addDays(1).toDateString().slice(0, -5);
seventhDay.innerHTML = addDays(1).toDateString().slice(0, -5);
...
form.addEventListener("submit", e => {
    ...
    let apiRes = `{
      ...
      // updateWeather(JSON.parse(apiRes))
